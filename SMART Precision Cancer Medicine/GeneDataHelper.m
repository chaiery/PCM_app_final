...
static NSArray *shallowGenePieSliceColors;
    ...
    if (self)
    {
        if (!geneIndexList)
        {
            ...
            genePieSliceColors = @[[UIColor colorWithRed:1.0f green:0.0f blue:1.0f alpha:1.0f],                          //AKT1   :#FF00FF
                                   ...
                                   [UIColor colorWithRed:33.0f/255.0f green:124.0f/255.0f blue:126.0f/255.0f alpha:1.0f],//NOT DETECTED   :#217C7E
                                   ];
            shallowGenePieSliceColors = @[[UIColor colorWithRed:1.0f green:0.0f blue:1.0f alpha:0.2f],                          //AKT1   :#FF00FF
                                   [UIColor colorWithRed:16.0f/255.0f green:150.0f/255.0f blue:24.0f/255.0f alpha:0.2f], //BRAF   :#109618
                                   [UIColor colorWithRed:0.0f green:0.0f blue:1.0f alpha:0.2f],                          //CTNNB1 :#0000FF
                                   [UIColor colorWithRed:1.0f green:153.0f/255.0f blue:0.0f alpha:0.2f],                 //DNMT3A :#FF9900
                                   [UIColor colorWithRed:255.0f/255.0f green:1.0f blue:0.0f alpha:0.2f],                 //EGFR   :#FFFF00
                                   [UIColor colorWithRed:1.0f green:175.0f/255.0f blue:175.0f/255.0f alpha:0.2f],        //ERBB2  :#FFAFAF
                                   [UIColor colorWithRed:204.0f/255.0f green:64.0f/255.0f blue:51.0f/255.0f alpha:0.2f], //FLT3   :#CC4033
                                   [UIColor colorWithRed:0.0f green:1.0f blue:0.0f alpha:0.2f],                          //GNA11  :#00FF00
                                   [UIColor colorWithRed:153.0f/255.0f green:0.0f blue:0.0f alpha:0.2f],                 //GNAQ   :#990000
                                   [UIColor colorWithRed:153.0f/255.0f green:204.0f/255.0f blue:51.0f/255.0f alpha:0.2f],//IDH1   :#99CC33
                                   [UIColor colorWithRed:102.0f/255.0f green:51.0f/255.0f blue:204.0f/255.0f alpha:0.2f],//IDH2   :#6633CC
                                   [UIColor colorWithRed:0.0f green:153.0f/255.0f blue:204.0f/255.0f alpha:0.2f],        //KIT    :#0099CC
                                   [UIColor colorWithRed:153.0f/255.0f green:0.0f blue:153.0f/255.0f alpha:0.2f],         //KRAS   :#990099
                                   [UIColor colorWithRed:0.0f green:1.0f blue:1.0f alpha:0.2f],                          //MAP2K1 :#00FFFF
                                   [UIColor colorWithRed:204.0f/255.0f green:51.0f/255.0f blue:191.0f/255.0f alpha:0.2f],//NPM1   :#CC33BF
                                   [UIColor colorWithRed:220.0f/255.0f green:57.0f/255.0f blue:18.0f/255.0f alpha:0.2f], //NRAS   :#DC3912
                                   [UIColor colorWithRed:0.0f green:85.0f/255.0f blue:254.0f/255.0f alpha:0.2f],         //PIK3CA :#0055FE
                                   [UIColor colorWithRed:1.0f green:204.0f/255.0f blue:17.0f/255.0f alpha:0.2f],         //PTEN   :#FFCC11
                                   [UIColor colorWithRed:1.0f green:0.0f blue:0.0f alpha:0.2f],                          //SMAD4  :#FF0000
                                   [UIColor colorWithRed:33.0f/255.0f green:124.0f/255.0f blue:126.0f/255.0f alpha:0.2f],//NOT DETECTED   :#217C7E
                                   ];
            ...
            genePieLabelColors = @[[UIColor blackColor], //AKT1
                                   ...
                                   [UIColor blackColor], //NOT DETECTED
                                   ];
           ...
           /* geneReferenceURLs = @[[NSURL URLWithString:@"http://en.m.wikipedia.org/wiki/AKT1"],
                                  ...
                                  [NSURL URLWithString:@"http://www.mycancergenome.org/content/disease/colorectal-cancer/kras/44/"],
                                  ];*/
...
- (UIColor *)geneColorWithIndex:(NSUInteger)index
{
    if(index < geneListCount)
        ...
        index = index % geneListCount;
        return genePieSliceColors[index];
    }
}

- (UIColor *)geneShallowColorWithIndex:(NSUInteger)index
{
    if(index < geneListCount)
        return shallowGenePieSliceColors[index];
    else{
        index = index % geneListCount;
        return shallowGenePieSliceColors[index];
    }
...
- (NSURL *)getReferenceURLForGene:(NSString *)geneName
{
    NSString *referenceURLString = @"http://en.m.wikipedia.org/wiki/";
    referenceURLString = [referenceURLString stringByAppendingString:geneName];
    NSLog(@"%@",referenceURLString);
    NSURL *geneReferenceURL = [NSURL URLWithString:referenceURLString];
    
    return geneReferenceURL;
}

/*
- (NSURL *)getReferenceURLForGeneAtIndex:(NSUInteger)index
{
    if (index <= geneListCount)
