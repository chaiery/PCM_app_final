...
- (void)loadView
{
    ...
    UIButton *licenseLink, *vandyLink, *smartOnFhirLink, *smartLink, *fhirLink, *corePlotLink, *svProgressHUDLink, *jeremyLink;
    ...
    usageBlue.text = @"Use of SMART Precision Cancer Medicine Mobile App Data";
    ...
    usageText.text = @"The following Terms and Conditions apply for use of SMART Precision Cancer Medicine mobile app data. Downloading data indicates your acceptance of the following Terms and Conditions. These Terms and Conditions apply to all data obtained from the SMART Precision Cancer Medicine mobile app, independent of format and method of acquisition.";
    ...
    ackText.text = @"The SMART Precision Cancer Medicine Team would like to thank and acknowledge key organizations and contributors that have made this mobile application possible.";
    ...
    corePlotLink = [UIButton buttonWithType:UIButtonTypeSystem];
    [_aboutView addSubview:corePlotLink];
    corePlotLink.translatesAutoresizingMaskIntoConstraints = NO;
    [corePlotLink setTitle:@"CorePlot" forState:UIControlStateNormal];
    [corePlotLink addTarget:self action:@selector(openCorePlotLink:) forControlEvents:UIControlEventTouchUpInside];
    
    svProgressHUDLink = [UIButton buttonWithType:UIButtonTypeSystem];
    [_aboutView addSubview:svProgressHUDLink];
    svProgressHUDLink.translatesAutoresizingMaskIntoConstraints = NO;
    [svProgressHUDLink setTitle:@"SVProgressHUD" forState:UIControlStateNormal];
    [svProgressHUDLink addTarget:self action:@selector(openSVProgressHUDLink:) forControlEvents:UIControlEventTouchUpInside];
    ...
    ackText2.text = @"Development of this app has been possible due to the generous support of the Office of the National Coordinator of Health Information Technology’s Strategic Health IT Advanced Research Projects program (90TR0001/01) and the T.J. Martell Foundation, a 501(c)3 non-profit organization that supports innovative groundbreaking research for leukemia, cancer and AIDS.";
    ...
    [_aboutView addConstraints:
     [NSLayoutConstraint constraintsWithVisualFormat:@"V:|[mainHeader]"
                                                        "-20-[legalHeader]"
                                                        "-[legalSpacer]"
                                                        "-[topBlurb]"
                                                        "-[licenseLink]"
                                             ...
                                             metrics:nil
                                               views:NSDictionaryOfVariableBindings(mainHeader,
                                                                                    legalHeader,
                                                                                    legalSpacer,
                                                                                    topBlurb,
                                                                                    licenseLink,
    ...
    [self.view addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"V:|-(20)-[scrollView]|"
                                                                      options:NSLayoutFormatAlignAllLeft
                                                                      metrics:nil
                                                                        views:@{@"scrollView": _scrollView}]];
...
- (void)openCorePlotLink:(id)sender
{
    [[UIApplication sharedApplication] openURL:[NSURL URLWithString:@"https://github.com/core-plot/core-plot"]];
}

- (void)openSVProgressHUDLink:(id)sender
{
    [[UIApplication sharedApplication] openURL:[NSURL URLWithString:@"https://github.com/TransitApp/SVProgressHUD"]];
}
